# GMAT - Terminator (DI Review)

## Overview

The **GMAT - Terminator (DI Review)** is a custom GPT designed to act as a post-class assistant, helping you interactively review the Terminator DI course.

- **Name**: GMAT - Terminator (DI Review)

## Description

A post-class assistant to help you interactively review the Terminator DI course. **Note**: Please ensure that "Search my knowledge" is enabled each time. If not, restart the conversation or remind the GPT to "search your knowledge."
...
- **RC Course Materials**: PDF/docx/pptx files containing the course handouts.  
...
For actual interaction with the GMAT - Terminator (RC Review), please visit: [GMAT - Terminator (DI Review)](https://chatgpt.com/g/g-677214e1ea1881919c86ed6fc8c0e223-gmat-terminator-di-review) 
